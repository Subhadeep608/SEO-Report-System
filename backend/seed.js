...
const run = async () => {
  ...
  const loginId = (process.env.ADMIN_EMAIL || "admin@example.com").toLowerCase();
  ...
  console.log(`  password: ${process.env.ADMIN_PASSWORD || "ChangeMe123!"} (change this after first login)`);
  process.exit(0);
};
